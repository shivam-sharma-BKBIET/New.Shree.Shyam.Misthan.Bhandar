...
const WhatsAppButton = () => {
  ...
  return (
    <div className={`whatsapp-wrapper ${isOpen ? 'active' : ''}`}>
      {isOpen && (
          ...
          <div className="menu-body">
            {numbers.map((num, idx) => (
              <a 
                ...
                className="menu-item"
              >
                <div className="item-icon"><Phone size={16} /></div>
                <div className="item-info">
                  <span className="item-label">{num.label}</span>
                  <span className="item-phone">+91 {num.phone}</span>
                </div>
              </a>
            ))}
          </div>
