...
const Products = () => {
  ...
  // Replaced activeCategory useState with useMemo derived value directly
  const activeCategory = searchParams.get('category') || 'All';
  const [searchQuery, setSearchQuery] = useState(initialSearch);

  // Sync search input query with URL param when changed externally (e.g., Clear Filters)
  useEffect(() => {
  ...
  // Replaced filteredProducts useState + useEffect with a derived useMemo value
